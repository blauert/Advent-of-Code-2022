...
Fortunately, your familiarity with analyzing the path of falling material will come in handy here. You scan a two-dimensional vertical slice of the cave above you (your puzzle input) and discover that it is mostly __air__ with structures made of __rock__.
...
You don't have time to scan the floor, so assume the floor is an infinite horizontal line with a `y` coordinate equal to __two plus the highest `y` coordinate__ of any point in your scan.
...
Using your scan, simulate the falling sand until the source of the sand becomes blocked. __How many units of sand come to rest?__